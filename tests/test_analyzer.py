...
@patch("cybermule.executors.llm_runner.get_llm_provider")
@patch("cybermule.executors.llm_runner.get_prompt_path")
@patch("cybermule.executors.llm_runner.render_template")
